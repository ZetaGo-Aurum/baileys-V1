...
console.log(chalk.green.bold('║           ZETAGO-AURUM - WASOCKET          ║'));
console.log(chalk.green.bold('║        Premium WhatsApp Socket Library     ║'));
console.log(chalk.green.bold('╚════════════════════════════════════════════╝'));
...
(async () => {
    try {
        ...
        const res = await fetch('https://registry.npmjs.org/@zetagoaurum-socket/wasocket/latest');
...
exports.MOBILE_USERAGENT = `WhatsApp/${WA_VERSION} iOS/17.5.1 Device/Apple-iPhone_14_Pro`;
...
exports.DEFAULT_CONNECTION_CONFIG = {
    ...
    browser: ['Windows', 'Chrome', '22.0.0.0'],
