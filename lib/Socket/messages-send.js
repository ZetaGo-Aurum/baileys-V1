...
const { ContactManager } = require("../Utils/auto-contact");
...
const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, cachedGroupMetadata, useCachedGroupMetadata, statusJidList, AI = false }) => {
        ...
        // [AI BADGE FIX v2.1.8] Inject supportPayload into content instead of using risky transport node
        if (AI) {
        ...
        await authState.keys.transaction(async () => {
            ...
            /* [REMOVED IN v2.1.8] Risky transport node causes message drops
            if (AI) {
                const botNode = {
                    tag: 'bot', 
                    attrs: {
    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            // FORCE AI BADGES FOR ALL MESSAGES
            ...
            await relayMessage(jid, fullMsg.message, {
                ...
                AI: true // Ensure relayMessage knows it's AI
            });
