...
const getUrlInfo = async (text, opts = {
    ...
    try {
        ...
        const info = await getLinkPreview(previewLink, {
            ...
            // headers: opts.fetchOpts // [FIX] Do not pass fetchOpts as headers, this causes 400 Bad Request
        });
        ...
        if (!error.message.includes('receive a valid')) {
             // [FIX] Log error but do not crash/throw for link preview failures
             (_a = opts.logger) === null || _a === void 0 ? void 0 : _a.debug({ err: error.stack, url: text }, 'error in fetching link preview');
             // throw error; // Safe to ignore link preview errors
        }
    }
};
